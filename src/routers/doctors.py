...
@router.get("/{slug}/reviews", response_model=list[ReviewRow])
def get_doctor_reviews(slug: str) -> list[ReviewRow]:
    ...
    return ReviewController.list_published_for(doctor_id)
